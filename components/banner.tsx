    ...
    return (
        <div className="md:mt-14 flex-1 z-10 w-full flex md:flex-row flex-col md:items-center items-start justify-between md:px-12 px-6 ">
            <div className="md:h-full h-1/2 md:w-1/2 w-full flex flex-col md:items-start md:justify-center items-start md:gap-4 font-[inter-bold]">
                    <span className="text-[0.9rem] md:test-md">Hi 👋, I'm <span>Vivek Gaindhar</span></span>
                    <h2 className="md:text-[3.2rem] pl-1 md:pl-5 text-[1.8rem] text-[#010200] font-[inter-extrabold] md:leading-[2.8rem] leading-[1.6rem] mt-2 text-left uppercase md:scale-x-115 scale-x-105 ">Multi-Agent <br /> Work-flows <br /> & Systems .</h2>
            </div>
